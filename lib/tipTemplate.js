...
function tipTemplate(params, callback) {
  // console.log(params)
  var tips = callback(params);
  var valueContainer = document.createElement('span');
  var gridBody = document.getElementById('borderLayout_eGridPanel');
  ...
  var addMessageBox = function addMessageBox(e) {
  ...
  var moveMessageBox = function moveMessageBox() {
    console.log('leave....');
  ...
  tip.innerHTML = tipsIcon[tips.type] ? tipsIcon[tips.type] : '';
  ...
  valueContainer.innerHTML = tips.value ? tips.value + '&nbsp;&nbsp;' : '';
  valueContainer.appendChild(tip);
  return valueContainer;
}

exports.default = tipTemplate;