...
var PageNumChange = _wrapComponent('PageNumChange')(function (_React$Component) {
  ...
  function PageNumChange() {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (PageNumChange.__proto__ || (0, _getPrototypeOf2.default)(PageNumChange)).call(this));
  ...
  (0, _createClass3.default)(PageNumChange, [{
    ...
    value: function render() {
      var selectItem = this.props.pagesize[0];
      return _react3.default.createElement(
        'div',
        { className: 'page-size-container' },
        _react3.default.createElement(
          'select',
          { defaultValue: selectItem, onChange: this.pageSizeChange },
          this.props.pagesize.sort().map(function (item, index) {
            return _react3.default.createElement(
              'option',
...
PageNumChange.propTypes = {
  pagesize: _react3.default.PropTypes.array,
