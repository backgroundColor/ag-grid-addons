...
SearchFilter.prototype.setupGui = function (params) {
    ...
    this.gui.innerHTML = '<div style="width: auto;">' + '<div style="background-color:#e0e1e2;padding-left:8px;font-size:12px;line-height:20px;' + 'border-bottom:1px solid #A9A9A9">查询</div>' + '<div style="margin:15px 8px;white-space:nowrap">' + '<input class="ag-grid-filter-input" type="text" id="filterText" placeholder="搜索..."/>' + '<button class="ag-grid-filter-btn" id="filterTextSubmit" style="vertical-align: bottom">' + searchIcon + '</button>' + '<div>' + '</div>';
